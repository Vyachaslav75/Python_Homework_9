...
let virtual-env = "D:\Слава\Учеба Python_GeekBrains\Знакомство с Python\Sem_9\New_Bot"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Слава\Учеба Python_GeekBrains\Знакомство с Python\Sem_9\New_Bot\Scripts\deactivate.nu"
